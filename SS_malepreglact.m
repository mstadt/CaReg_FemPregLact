...
% male preg file
fname2 = './SS/16-May-2023_calcium_mod_SS_sexORrep-malepreg_notes-malepreglact.mat';
SSdat2 = load(fname2);
vals2 = SSdat2.valsSS;
SS2 = SSdat2.SS;
lab2 = 'male preg';
...
% male lact file
fname3 = './SS/16-May-2023_calcium_mod_SS_sexORrep-malelact_notes-malepreglact.mat';
SSdat3 = load(fname3);
vals3 = SSdat3.valsSS;
SS3 = SSdat3.SS;
lab3 = 'male lact';
...
for ii = 1:length(SSdat4.param_names)
    ...
    assignin('base', assign_name, SSdat2.par_malepreg(ii));
end

for ii = 1:length(SSdat4.param_names)
    assign_name = strcat(SSdat4.param_names{ii},'_3');
    assignin('base', assign_name, SSdat3.par_malelact(ii));
end
